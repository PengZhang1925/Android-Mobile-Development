...
public class PreCalendar extends GridView {
    Context context;
    ...
    public PreCalendar(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        this.context = context;
    }

    public PreCalendar(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
    }

    public PreCalendar(Context context) {
        super(context);
        this.context = context;
    }
    ...
    public void initCalendar(){
        ...
        this.adapter = new CalendarAdapter(context, items);
    ...
    private void initCalendarItems(int year, int month, int day) {
        ...
        if(firstDayOfWeek != 1)
        {
            for(int i = predays - firstDayOfWeek + 2; i <= predays; i++){
                CalendarItem cb = new CalendarItem();
                cb.setDateString(i+"");
        ...
        if(adapter == null){
            adapter = new CalendarAdapter(context, items);
        }
